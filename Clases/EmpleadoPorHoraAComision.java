...
public class EmpleadoPorHoraAComision extends EmpleadoPorHora {
	 ...
	 * @throws ErrorDeComision 
	 */
	public EmpleadoPorHoraAComision(String nombre, String cuil, double sueldoPorHora , int comision) throws NumberFormatException, CuilInvalidoExcepcion, ErrorDeComision {
